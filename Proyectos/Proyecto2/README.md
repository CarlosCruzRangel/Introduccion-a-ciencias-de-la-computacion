...
<div align="center">
  ...
  <h3 align="center">PROYECTO 2: SOLRESOL</h3>
...
# Sobre el Proyecto
## Introducción
François Sudre inventó un lenguaje muy simple con la finalidad de estudiar idiomas extranjeros que no se asemejaba a ningún lenguaje existente, por lo que el resultado era absolutamente neutral.

El lenguaje que inventó, llamado ***Solresol***, está constituido enteramente por las siete sílabas musicales: *do, re, mi, fa, sol, la y si*, sin embargo, no es necesario estar familiarizado con la música para aprenderlo.

En este proyecto se implementan algunos métodos que permiten trabajar con la gramática de Solresol.

## Sobre Solresol
Aunque Solresol tiene varias reglas para entenderlo y hablarlo, en el proyecto nos centraremos en unas reglas básicas. Para más detalles sobre Solresol, se puede consultar el siguiente enlace: [Grammar of Solresol](https://i.sidosi.org/resources/grammar-of-solresol/grammar-of-solresol.html#nos).
